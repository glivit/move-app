    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-[#F0F0ED] p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            <p className="text-[28px] font-bold text-[#8B6914]">
      ...
      {profile?.stripe_customer_id && (
        <a
          ...
          className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-[#F0F0ED] p-5 flex items-center justify-between hover:bg-[#FAFAFA] transition-colors"
        >
          <div className="flex items-center gap-3">
            <ExternalLink strokeWidth={1.5} className="w-5 h-5 text-[#8B6914]" />
            <div>
