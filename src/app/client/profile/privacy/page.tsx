...
export default function PrivacyPage() {
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      {/* Privacy Shield */}
      <div className="bg-[#A6ADA7] rounded-2xl border border-[rgba(253,253,254,0.08)] p-6 flex flex-col items-center text-center">
        ...
        <h2 className="text-[17px] font-semibold text-[#FDFDFE] mb-2">Jouw gegevens zijn veilig</h2>
        <p className="text-[13px] text-[rgba(253,253,254,0.55)] leading-relaxed">
      ...
      <div className="bg-[#A6ADA7] rounded-2xl border border-[rgba(253,253,254,0.08)] divide-y divide-[rgba(253,253,254,0.08)]">
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#FDFDFE] mb-2">Welke gegevens verzamelen we?</h3>
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#FDFDFE] mb-2">Hoe gebruiken we je gegevens?</h3>
          <p className="text-[14px] text-[rgba(253,253,254,0.55)] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#FDFDFE] mb-2">Waar worden gegevens opgeslagen?</h3>
          <p className="text-[14px] text-[rgba(253,253,254,0.55)] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#FDFDFE] mb-2">Wie heeft toegang?</h3>
          <p className="text-[14px] text-[rgba(253,253,254,0.55)] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#FDFDFE] mb-2">Gegevens verwijderen</h3>
          <p className="text-[14px] text-[rgba(253,253,254,0.55)] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#FDFDFE] mb-2">GDPR-rechten</h3>
          <p className="text-[14px] text-[rgba(253,253,254,0.55)] leading-relaxed">
      ...
      <div className="bg-[#A6ADA7] rounded-2xl border border-[rgba(253,253,254,0.08)] p-5">
        <p className="text-[13px] text-[rgba(253,253,254,0.55)] text-center">
          Vragen over je privacy? Neem contact op via{' '}
          <a href="/client/messages" className="text-[#FDFDFE] font-medium">Berichten</a>
          {' '}of e-mail naar{' '}
          <span className="text-[#FDFDFE] font-medium">info@movecoaching.be</span>
        </p>
      </div>

      <p className="text-[11px] text-[rgba(253,253,254,0.48)] text-center">Laatst bijgewerkt: maart 2026</p>
    </div>
  )
}
