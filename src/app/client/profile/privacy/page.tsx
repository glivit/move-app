  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-[rgba(255,255,255,0.50)] backdrop-blur-md rounded-2xl border border-[rgba(28,30,24,0.10)] p-6 flex flex-col items-center text-center">
        ...
        <h2 className="text-[17px] font-semibold text-[#1C1E18] mb-2">Jouw gegevens zijn veilig</h2>
        <p className="text-[13px] text-[rgba(28,30,24,0.62)] leading-relaxed">
      ...
      <div className="bg-[rgba(255,255,255,0.50)] backdrop-blur-md rounded-2xl border border-[rgba(28,30,24,0.10)] divide-y divide-[rgba(28,30,24,0.10)]">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1C1E18] mb-2">Hoe gebruiken we je gegevens?</h3>
          <p className="text-[14px] text-[rgba(28,30,24,0.62)] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1C1E18] mb-2">Waar worden gegevens opgeslagen?</h3>
          <p className="text-[14px] text-[rgba(28,30,24,0.62)] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1C1E18] mb-2">Wie heeft toegang?</h3>
          <p className="text-[14px] text-[rgba(28,30,24,0.62)] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1C1E18] mb-2">Gegevens verwijderen</h3>
          <p className="text-[14px] text-[rgba(28,30,24,0.62)] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1C1E18] mb-2">GDPR-rechten</h3>
          <p className="text-[14px] text-[rgba(28,30,24,0.62)] leading-relaxed">
      ...
      <div className="bg-[rgba(255,255,255,0.50)] backdrop-blur-md rounded-2xl border border-[rgba(28,30,24,0.10)] p-5">
        <p className="text-[13px] text-[rgba(28,30,24,0.62)] text-center">
          ...
          {' '}of e-mail naar{' '}
          <span className="text-[#1C1E18] font-medium">info@movecoaching.be</span>
        </p>
      </div>

      <p className="text-[11px] text-[rgba(28,30,24,0.60)] text-center">Laatst bijgewerkt: maart 2026</p>
    </div>
  )
}
