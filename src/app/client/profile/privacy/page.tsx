  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-[#F0F0EE] p-6 flex flex-col items-center text-center">
        ...
        <h2 className="text-[17px] font-semibold text-[#1A1A18] mb-2">Jouw gegevens zijn veilig</h2>
      ...
      <div className="bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] border border-[#F0F0EE] divide-y divide-[#F0F0EE]">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1A1A18] mb-2">Hoe gebruiken we je gegevens?</h3>
          <p className="text-[14px] text-[#8E8E93] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1A1A18] mb-2">Waar worden gegevens opgeslagen?</h3>
          <p className="text-[14px] text-[#8E8E93] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1A1A18] mb-2">Wie heeft toegang?</h3>
          <p className="text-[14px] text-[#8E8E93] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1A1A18] mb-2">Gegevens verwijderen</h3>
          <p className="text-[14px] text-[#8E8E93] leading-relaxed">
        ...
        <div className="px-5 py-5">
          <h3 className="text-[15px] font-semibold text-[#1A1A18] mb-2">GDPR-rechten</h3>
          <p className="text-[14px] text-[#8E8E93] leading-relaxed">
      ...
      <p className="text-[11px] text-[#C7C7CC] text-center">Laatst bijgewerkt: maart 2026</p>
    </div>
  )
}
