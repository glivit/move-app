                ...
                >
                  {resource.thumbnail_url ? (
                    <div className="relative aspect-[21/9] overflow-hidden">
                      <Image src={resource.thumbnail_url} alt="" width={400} height={171} sizes="(max-width: 600px) 100vw, 400px" className="w-full h-full object-cover" loading="lazy"  unoptimized/>
              ...
              >
                {resource.thumbnail_url ? (
                  <div className="relative aspect-video overflow-hidden">
                    <Image src={resource.thumbnail_url} alt="" width={400} height={225} sizes="(max-width: 600px) 100vw, 400px" className="w-full h-full object-cover" loading="lazy"  unoptimized/>
                    {resource.content_type === 'video' && (
                      <div className="absolute inset-0 flex items-center justify-center bg-black/20">
          ...
          <div className="relative w-full max-w-2xl mx-4 mb-4 lg:mb-0 max-h-[85vh] overflow-y-auto bg-white dark:bg-[#1C1E18] rounded-2xl">
            ...
            {selectedResource.content_type !== 'video' && selectedResource.thumbnail_url && (
              <div className="aspect-[21/9] overflow-hidden">
                <Image src={selectedResource.thumbnail_url} alt="" width={400} height={171} sizes="(max-width: 600px) 100vw, 400px" className="w-full h-full object-cover" loading="lazy"  unoptimized/>
              </div>
            )}
