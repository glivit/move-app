  ...
  return (
    <div className="space-y-8">
      ...
      <div className="animate-pulse">
        ...
        <div className="h-4 w-64 bg-[#E5E1D9] rounded mt-2" />
      </div>

      {/* Pending section */}
      <div>
        <div className="h-5 w-32 bg-[#E5E1D9] rounded mb-4 animate-pulse" />
      ...
      {/* Reviewed section */}
      <div>
        <div className="h-5 w-28 bg-[#E5E1D9] rounded mb-4 animate-pulse" />
        <div className="space-y-3">
