...
interface BillingViewProps {
  initialClients: ClientSubscription[];
}

export default function BillingView({ initialClients }: BillingViewProps) {
  const [clients] = useState<ClientSubscription[]>(initialClients);
          ...
          <Card className="p-6 bg-[#A6ADA7] border border-client-border rounded-2xl shadow-clean">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-text-primary">{pastDueCount}</p>
              </div>
          ...
          <Card className="p-6 bg-[#A6ADA7] border border-client-border rounded-2xl shadow-clean">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-text-primary">{cancelledCount}</p>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-client-border">
                    <th className="px-6 py-4 text-left text-[13px] font-medium text-text-primary">Cliënt</th>
                    <th className="px-6 py-4 text-left text-[13px] font-medium text-text-primary">Pakket</th>
                    <th className="px-6 py-4 text-left text-[13px] font-medium text-text-primary">Status</th>
                    <th className="px-6 py-4 text-left text-[13px] font-medium text-text-primary">Startdatum</th>
                    <th className="px-6 py-4 text-right text-[13px] font-medium text-text-primary">Prijs</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      >
                        <td className="px-6 py-4">
                          <div>
                            ...
                            <p className="text-[13px] text-client-text-secondary">{client.email}</p>
                          </div>
                        </td>
                        <td className="px-6 py-4">
