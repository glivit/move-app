                  ...
                  return (
                    <div key={idx} className="space-y-2">
                      <div className="relative aspect-[3/4] rounded-xl overflow-hidden bg-[#A6ADA7] border border-[#A6ADA7]">
                        {photoUrl ? (
                          <Image src={photoUrl} alt={`${entry.label} ${positionLabels[photoPosition]}`} width={400} height={500} sizes="(max-width: 600px) 50vw, 25vw" className="w-full h-full object-cover" loading="lazy"  unoptimized/>
                        ) : (
                      ...
                      return (
                        <div key={idx}>
                          <div className="relative aspect-[3/4] rounded-xl overflow-hidden bg-[#A6ADA7]">
                            {photoUrl ? (
                              <Image src={photoUrl} alt={entry.label} width={400} height={500} sizes="(max-width: 600px) 50vw, 25vw" className="w-full h-full object-cover" loading="lazy"  unoptimized/>
                            ) : (
