...
export default function ExercisesView({ initialExercises, initialCount }: ExercisesViewProps) {
  ...
  // Only fetch client-side when filters change (not on initial render)
  useEffect(() => {
    if (hasFilters) {
      fetchExercises()
    }
  }, [fetchExercises, hasFilters])
