...
export function ClientCard({ client }: ClientCardProps) {
  return (
    <div className="bg-white rounded-2xl shadow-clean p-5 hover:shadow-clean-hover transition-shadow duration-200 flex flex-col h-full">
      <div className="flex flex-col h-full">
        ...
        <Link href={`/coach/clients/${client.id}`}>
          <div className="inline-flex items-center gap-2 text-[13px] font-medium text-accent-dark hover:text-text-primary transition-colors group">
